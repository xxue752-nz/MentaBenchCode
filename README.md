...
## For more detailed deployment instructions, see [`Menta_deployment/SETUP.md`](./Menta_deployment)
## For more detailed training instructions, see [`Menta_pretraining_code/README.md`](./Menta_pretraining_code)
### Key Features
